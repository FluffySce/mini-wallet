...
export function TransferForm({ onSuccess }: Props) {
  ...
  const handleTransfer = async () => {
    ...
    try {
      ...
      console.error(err);
      setError("Transfer failed. Please check the email and try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
            ...
            <div className="relative">
              ...
              <Input
                ...
                p-3
                  ...
                  focus-visible:shadow-[0_0_0_3px_rgba(59,130,246,0.12)]
      ...
      {success && (
        <SuccessMessage message="✓ Transfer completed!" duration={3000} />
      )}
    </>
  );
}
